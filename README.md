...
![Чат гейта: анонимная сессия, запрос, стрим ответа, история](docs/demo.png)

Для вакансии этого кадра достаточно, чтобы ревьюер увидел UI без запуска. Ещё сильнее — 30–60 секунд записи экрана (Win+G): открыл форму → отправил запрос → стрим → F5, история на месте.
